  ...
  return (
    <div className="mx-auto flex flex-col items-center gap-sm px-md py-2xl text-center">
      ...
      <p className="text-sm font-medium text-foreground">
        Tax summary isn&apos;t available yet
      </p>
      <p className="text-xs text-muted-foreground">
        This school hasn&apos;t configured a statutory tax policy
        (PF/ESI/TDS/professional tax). Payroll deductions here are limited to
        the components an administrator defines explicitly.
      </p>
    </div>
  );
}
