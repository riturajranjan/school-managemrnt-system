  ...
  return (
    <div className="mx-auto flex flex-col items-center gap-sm px-md py-2xl text-center">
      ...
      <p className="text-sm font-medium text-foreground">
        Employee loans aren&apos;t available yet
      </p>
      <p className="text-xs text-muted-foreground">
        This school hasn&apos;t configured a lending policy. Loan origination
        and recovery scheduling require rules this product doesn&apos;t define
        yet.
      </p>
    </div>
  );
