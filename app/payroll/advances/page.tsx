...
export default function PayrollAdvancesPage() {
  return (
    <div className="mx-auto flex max-w-md flex-col items-center gap-sm px-md py-2xl text-center">
      ...
      <p className="text-sm font-medium text-foreground">Salary advances aren&apos;t available yet</p>
      <p className="text-xs text-muted-foreground">This school hasn&apos;t configured an advance policy. Advance issuance and recovery-against-payroll require rules this product doesn&apos;t define yet.</p>
    </div>
  );
}
