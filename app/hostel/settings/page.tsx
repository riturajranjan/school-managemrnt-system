    ...
    <div className="mx-auto flex w-full  flex-col gap-md pb-20 sm:pb-0">
      <div>
        ...
        <p className="text-xs text-muted-foreground">
          Buildings, wardens and configuration
        </p>
      </div>
      <section className="rounded-lg border border-border bg-surface p-md">
        <h2 className="mb-sm flex items-center gap-1 text-sm font-semibold text-foreground">
          <Building2 className="size-4" /> Buildings & wardens
        </h2>
          ...
          {db.hostelBuildings.map((b) => (
            <div
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  {hostelTypeLabels[b.type]} · {b.floors} floors · Warden{" "}
                  {b.wardenName}
                </p>
              </div>
      ...
      <section className="rounded-lg border border-border bg-surface p-md">
        ...
        <p className="text-sm text-muted-foreground">
          Room types, facilities, mess plans and leave policies are managed here
          in a connected build. This module runs on typed frontend state;
