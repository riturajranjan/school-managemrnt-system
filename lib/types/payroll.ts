...
export type LoanStatus = "draft" | "submitted" | "approved" | "rejected" | "active" | "closed";
...
export type EmployeeAdvanceType = "salary-advance" | "emergency-advance" | "custom";

export const employeeAdvanceTypeLabels: Record<EmployeeAdvanceType, string> = {
  "salary-advance": "Salary advance",
  "emergency-advance": "Emergency advance",
  custom: "Custom advance",
};
