...
async function main() {
  ...
  await upsertTenantUser("cafeteria@novyra-demo.example", "Chef Cafeteria", "CAFETERIA_MANAGER");
  await upsertTenantUser("activities@novyra-demo.example", "Aditi Activities", "ACTIVITY_COORDINATOR");
  ...
  // =========================================================================
  // Phase 9E — real Staff Attendance + Leave Management
  // =========================================================================
  await seedStaffAttendanceLeave(prisma, { tenantId: tenant.id, schoolId: school.id, branchId: mainBranch.id, academicSessionId: academicSession.id });
